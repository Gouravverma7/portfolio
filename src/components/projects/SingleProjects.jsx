...
const SingleProjects = ({ name, year, align, image, link }) => {
  return (
    <motion.div variants={fadeIn('down',0.2)} initial='hidden' whileInView='show' viewport={{once:false, amount:0}} className={`flex w-full sm:flex-col-reverse items-center gap-8 mt-10 ${align === "left" ? "md:flex-row" : "md:flex-row-reverse"} justify-end `}>
      <div>
      ...
      <div className="max-h-[450px] max-w-[550px] rounded-xl overflow-hidden hover:scale-110 transform transition-all duration-500 relative border border-white ">
